...
await exists(db.create(databaseId, `Anasiya Custom Order`));
...
await exists(storage.createBucket(bucketId, `Catalog Images`, [Permission.read(Role.any()), Permission.create(Role.users()), Permission.update(Role.users()), Permission.delete(Role.users())], false, true, 20000000, [`jpg`, `jpeg`, `png`, `webp`]));
