(function () {
  ...
  function sizeStepBody(settings) {
    ...
    return `<div class="aco-size-layout"><div class="aco-panel aco-size-chart-panel"><h3>Size chart</h3>${sizeChartTable()}</div>${note}<div class="aco-panel aco-size-picker-panel"><h3>Select your size</h3><div class="aco-size-grid">${sizes.map((size) => `<button class="aco-size-btn ${state.size === size ? `is-selected` : ``}" data-size="${esc(size)}" type="button">${esc(size)}</button>`).join(``)}</div></div></div>`;
  }
  ...
  function render() {
    ...
    root.innerHTML = `<div class="aco-overlay" role="dialog" aria-modal="true" aria-label="Anasiya custom order"><div class="aco-shell"><header class="aco-top"><div class="aco-brand-wrap"><img src="https://anasiya-custom-order.appwrite.network/anasiya-logo.png" alt="Anasiya" class="aco-logo-img"><span class="aco-tagline">Inspired By A Beautiful Human, Turned Into Fashion</span></div><div class="aco-progress" aria-label="Step ${state.step + 1} of 4"><span class="aco-dot ${state.step === 0 ? `is-on` : ``}"></span><span class="aco-dot ${state.step === 1 ? `is-on` : ``}"></span><span class="aco-dot ${state.step === 2 ? `is-on` : ``}"></span><span class="aco-dot ${state.step === 3 ? `is-on` : ``}"></span></div><button class="aco-close" data-close type="button" aria-label="Close">&times;</button></header><main class="aco-stage"><section class="aco-page ${stepClass(0)}"><div class="aco-page-body"><div class="aco-head"><div><div class="aco-kicker">Step 1 of 4</div><h2 class="aco-title">Choose your style</h2><p class="aco-sub">Select a product card, or open it to view both photographs and every detail.</p></div></div>${productStepBody(catalog.products || [], currency)}</div><div class="aco-page-footer ${state.productDetail ? `has-back` : ``}">${productStepFooter()}</div></section><section class="aco-page ${stepClass(1)}"><div class="aco-page-body"><div class="aco-head aco-head-split"><div><div class="aco-kicker">Step 2 of 4</div><h2 class="aco-title">Select your print</h2><p class="aco-sub">Choose the fabric or print you would like with your selected style.</p></div>${state.product ? selectedProductBadge(state.product, currency) : ``}</div>${fabricStepBody(catalog.fabrics || [])}</div><div class="aco-page-footer has-back">${fabricStepFooter()}</div></section><section class="aco-page ${stepClass(2)}"><div class="aco-page-body"><div class="aco-head"><div><div class="aco-kicker">Step 3 of 4</div><h2 class="aco-title">Choose your size</h2><p class="aco-sub">Use the size chart and sizing note below, then select the size that fits you best.</p></div></div>${sizeStepBody(catalog.settings || {})}</div><div class="aco-page-footer has-back">${sizeStepFooter()}</div></section><section class="aco-page ${stepClass(3)}"><div class="aco-page-body"><div class="aco-head"><div><div class="aco-kicker">Step 4 of 4</div><h2 class="aco-title">Review and pay</h2><p class="aco-sub">Check your selection before moving to secure Shopify checkout.</p></div></div>${reviewStepBody(currency, catalog.settings || {})}</div><div class="aco-page-footer has-back">${reviewStepFooter()}</div></section></main></div></div>`;
